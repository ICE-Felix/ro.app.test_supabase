  ...
  public: {
    Tables: {
      ...
      event_tickets: {
        ...
        Relationships: [
          {
            foreignKeyName: "event_tickets_type_fkey"
            columns: ["type"]
            isOneToOne: false
      ...
      partners: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "partners_gallery_id_fkey"
            columns: ["gallery_id"]
            isOneToOne: false
            referencedRelation: "galleries"
            referencedColumns: ["id"]
      ...
      service_providers: {
        ...
        Relationships: [
          {
            foreignKeyName: "service_providers_contact_id_fkey"
            columns: ["contact_id"]
            isOneToOne: false
            referencedRelation: "contacts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "service_providers_gallery_id_fkey"
            columns: ["gallery_id"]
            isOneToOne: false
            referencedRelation: "galleries"
            referencedColumns: ["id"]
      ...
      services: {
        ...
        Relationships: [
          {
            foreignKeyName: "services_gallery_id_fkey"
            columns: ["gallery_id"]
            isOneToOne: false
            referencedRelation: "galleries"
            referencedColumns: ["id"]
      ...
      shops: {
        ...
        Relationships: [
          {
            foreignKeyName: "shops_gallery_id_fkey"
            columns: ["gallery_id"]
            isOneToOne: false
            referencedRelation: "galleries"
            referencedColumns: ["id"]
      ...
      ticket_eligibility: {
        ...
        Relationships: [
          {
            foreignKeyName: "ticket_eligibility_event_ticket_id_fkey"
      ...
      woo_product_tickets: {
        ...
        Relationships: [
          {
            foreignKeyName: "woo_product_tickets_ticket_id_fkey"
            columns: ["ticket_id"]
            isOneToOne: false
            referencedRelation: "event_tickets"
            referencedColumns: ["id"]
