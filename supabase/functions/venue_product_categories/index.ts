...
import { VenueProductCategoriesApiController } from "./controllers/VenueProductCategoriesApiController.ts";
...
export const handler = async (req: Request) => {
    try {
        ...
        const apiController = new VenueProductCategoriesApiController();
