...
import { ProductCategoriesApiController } from "./controllers/ProductCategoriesApiController.ts";
import { ProductCategoriesWebController } from "./controllers/ProductCategoriesWebController.ts";
...
export const handler = async (req: Request) => {
    try {
        ...
        const apiController = new ProductCategoriesApiController();
        const webController = new ProductCategoriesWebController();
