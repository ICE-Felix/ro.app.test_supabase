...
import { PushNotificationsApiController } from "./controllers/PushNotificationsApiController.ts";
import { PushNotificationsWebController } from "./controllers/PushNotificationsWebController.ts";
...
export const handler = async (req: Request) => {
    try {
        ...
        const apiController = new PushNotificationsApiController();
        const webController = new PushNotificationsWebController();
