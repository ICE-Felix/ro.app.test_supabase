...
import { VenueAttributesFiltersApiController } from "./controllers/VenueAttributesFiltersApiController.ts";
...
export const handler = async (req: Request) => {
    try {
        ...
        const apiController = new VenueAttributesFiltersApiController();
