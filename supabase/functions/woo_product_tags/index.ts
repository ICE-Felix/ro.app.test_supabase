...
import { ProductTagsApiController } from "./controllers/ProductTagsApiController.ts";
import { ProductTagsWebController } from "./controllers/ProductTagsWebController.ts";
...
export const handler = async (req: Request) => {
    try {
        ...
        const apiController = new ProductTagsApiController();
        const webController = new ProductTagsWebController();
