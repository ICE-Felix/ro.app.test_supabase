...
import { UserDevicesApiController } from "./controllers/UserDevicesApiController.ts";
import { UserDevicesWebController } from "./controllers/UserDevicesWebController.ts";
...
export const handler = async (req: Request) => {
    try {
        ...
        const apiController = new UserDevicesApiController();
        const webController = new UserDevicesWebController();
