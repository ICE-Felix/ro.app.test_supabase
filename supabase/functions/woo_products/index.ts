...
import { WooProductsApiController } from "./controllers/WooProductsApiController.ts";
import { WooProductsWebController } from "./controllers/WooProductsWebController.ts";
...
export const handler = async (req: Request) => {
    try {
        ...
        const apiController = new WooProductsApiController();
        const webController = new WooProductsWebController();
