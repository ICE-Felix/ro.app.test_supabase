...
export class WooStockCheckWebController extends Controller<Record<string, unknown>> {
  override get(_id?: string, _req?: Request): Promise<Response> {
    return Promise.resolve(
      ResponseService.error(
        "Web interface not supported for woo_stock_check",
        "WEB_NOT_SUPPORTED",
        405,
        {},
        ResponseType.WEB,
  ...
  override post(_data: Record<string, unknown>, _req?: Request): Promise<Response> {
    return Promise.resolve(
      ResponseService.error(
        "Web interface not supported for woo_stock_check",
        "WEB_NOT_SUPPORTED",
  ...
  override put(_id: string, _data: Record<string, unknown>, _req?: Request): Promise<Response> {
    return Promise.resolve(
      ResponseService.error(
        "Web interface not supported for woo_stock_check",
        "WEB_NOT_SUPPORTED",
